...
description: 'Manage where your videos can be viewed by allowing or blocking access from specific countries.'
sidebarTitle: 'Country Access Policy'
icon: 'globe-lock'
---

# Country Access Policy
**Country Access Policy** lets you manage where your videos can be viewed by allowing or blocking access based on the viewer’s country.
