---
title: 'Astro.js'
description: 'Integrate Tenbyte Image Optimization with Astro.js to deliver optimized, fast-loading images across your application'
sidebarTitle: 'Astro.js'
icon: 'braces'
---
# Tenbyte Image Integration for Astro.js
...
### 1. Create a Tenbyte Astro Component
...
/>
```
### 2. Load Tenbyte JS and Configure in Global Layout
...
```javascript Javascript
<TenbyteImage
  src="https://demo.tenbyte.io/logo.png?w=300"
  alt="Company logo"
  style="width:300px;"
/>
```
