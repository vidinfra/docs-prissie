...
This guide explains how to create and manage access delegations in Tenbyte Cloud. Access Delegation lets you share controlled access to your cloud resources with another user or system. You can grant limited access to a single billing account or full access to all resources under it.
