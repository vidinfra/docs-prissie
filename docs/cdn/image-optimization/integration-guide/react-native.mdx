---
title: 'React Native'
description: 'Set up Tenbyte Image Optimization in your React Native project to load compressed, device-friendly images on the fly'
sidebarTitle: 'React Native'
icon: 'braces'
---
# Integrate Tenbyte Image Optimization with React Native
