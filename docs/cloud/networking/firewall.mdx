...
# Tenbyte Firewall
This guide explains how to create and manage firewalls in Tenbyte Cloud. A firewall controls which traffic can reach or leave your VM through inbound and outbound rules. You will learn how to set these rules and attach the firewall to a VM from the dashboard.
