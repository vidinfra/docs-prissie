...
- Select your languages and upload the files and click on **Save subtitles**
     ...
     <Frame caption="Add Multiple Subtitles">
        <img src="/images/vidinfra/library-47.png" alt="Add Subtitles" />
     </Frame>
...
<Frame caption="Add Multiple Chapters">
        <img src="/images/vidinfra/library-48.png" alt="Add Chapters" />
    </Frame>
