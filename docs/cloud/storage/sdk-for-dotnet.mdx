...
You can take advantage of Tenbyte T2 Cloud Storage using the [AWS SDK for .NET](https://aws.amazon.com/sdk-for-net/) alongside the Tenbyte [S3-Compatible API](https://docs.tenbyte.io/docs/cloud/storage/object-storage).
