...
The Profile Settings page gives you a simple place to update your personal details and manage the information connected to your Tenbyte account. You can adjust your name, change your email preferences, set a password if you logged in through a social provider, and handle important actions such as account deletion. Everything is grouped in one area so you don’t have to look around the dashboard to make basic changes.
...
- The **Danger Zone** contains irreversible actions.
    ...
    <Frame caption="Critical Account Actions">
        <img src="/images/account/18.png" alt="Critical Account Actions" />
    </Frame>
